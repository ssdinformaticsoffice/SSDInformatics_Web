...
const Services = () => {
  ...
  return (
    <>
      <SEO
        title="Our Services | Web, App, ERP & Digital Marketing | SSD Informatics"
        description="Explore SSD Informatics services including website development, mobile app development, UI/UX design, ERP software, SEO, Google Ads, Meta Ads, graphic design and video editing."
        canonical="https://www.ssdinformatics.com/services"
      />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            >
              ...
              >
                ...
                technology solutions. We deliver innovation
                that drives results and accelerates your
            ...
            >
              ...
              >
                ...
                <motion.div
                  ...
                  style={{
                    x: useTransform(
                      useMotionValue(mouseX * 20),
                      (v) => v
                    ),
                    y: useTransform(
                      useMotionValue(mouseY * 20),
                      (v) => v
                    ),
                  }}
                />
          ...
          >
            ...
            <p className="mt-4 text-slate-300 max-w-2xl mx-auto text-base sm:text-lg">
              ...
              business needs, delivered with excellence and
              innovation.
            </p>
          </motion.div>
